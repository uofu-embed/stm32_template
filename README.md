...
## Unix installation
Students are encouraged to work in a Unix environment for this course.
If you wish, you may install Linux as your primary operating system, otherwise you will can set up a virtual environment.
